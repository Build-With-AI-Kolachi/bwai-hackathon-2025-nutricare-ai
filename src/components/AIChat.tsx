...
export const AIChat = ({ medicalProfile, analysisResult, className = "" }: AIChatProps) => {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      // Generate AI response using Gemini with image support
      ...
      const errorMessage: ChatMessage = {
        ...
        content: language === 'en' 
          ...
          : "معذرت، مجھے خرابی کا سامنا ہوا۔ برائے کرم دوبارہ کوشش کریں۔",
        timestamp: new Date()
      };
  ...
  }, [inputValue, isLoading, uploadedImage, medicalProfile, analysisResult, language]);
